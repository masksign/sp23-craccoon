...
//  === Portable & instrumented interface to 64-bit Montgomery arithmetic
...
//  (not instantiated here -- used to express CBMC proofs)
#define XASSERT(x)
#define XASSUME(x)
...
static inline int64_t mont64_redc(__int128 x)
{
    ...
    XASSERT(((((__int128)x) - (((__int128)r) << 64)) % ((__int128_t)RACC_Q)) ==
            0);
#endif
    return r;
}
