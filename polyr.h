...
void polyr_smul(int64_t *r, const int64_t *a, int64_t c);

//  Coefficient multiply:  r = a * b,  Montgomery reduction.
void polyr_cmul(int64_t *r, const int64_t *a, const int64_t *b);

//  Coefficient multiply and add:  r = a * b + c, Montgomery reduction.
void polyr_mula(int64_t *r,
...
//  Full polynomial product: r = a*b mod x^n+1 in Zq. ( Uses a lot of stack.)
void polyr_pmul(int64_t *r, const int64_t *a, const int64_t *b);
